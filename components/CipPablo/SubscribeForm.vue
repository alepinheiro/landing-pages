                ...
                axios
                    ...
                    .then((res) => {
                        ...
                        if (res.status == 200){
                            ...
                            window.fbq('track', this.form_name);
                            // tag manager
...
<template>
    <form id="form" class="pa-registration-form" @submit="submitForm" :name="form_name">

        <div class="pa-input-wrapper group">
          <input
            type="text"
            name="name"
            class="pa-input-form peer"
            v-model="nameInput"
            placeholder=" "
            required=""
          >
          <label for="name" class="pa-label-form">Nome Completo</label>
        </div>
        ...
        <div class="pa-input-wrapper group">
            <the-mask
                ...
                required
            />
          <label for="whatsapp" class="pa-label-form">WhatsApp</label>
        </div>
        ...
        <div class="pa-input-wrapper group">
            <input
                ...
                required
            >
            <label for="email" class="pa-label-form">E-mail</label>
        </div>
        ...
        <div class="flex flex-col items-start w-full gap-2">
            <div class="pa-checkbox-wrapper">
                <input checked id="terms-conditions" type="checkbox" value="" class="pa-checkbox-input " >
                <label
            ...
            <div class="pa-checkbox-wrapper">
                <input checked id="promotional-communication" type="checkbox" value="" class="pa-checkbox-input">
                <label
        ...
        <button type="submit" class="pa-btn-submit-form">
            <div class="btnText">
                quero me inscrever
            </div>
            <div v-if="loadingStatus" class="pa-btn-loading">
        ...
        <transition name="fade">
            <div v-if="isError || isSuccess" class="pa-msg-box" :class="{'bg-green-400 text-green-600': isSuccess, 'bg-red-400 text-red-600': isError,}">
                <p>{{apiMessage}}</p>
            </div>
        </transition>
    </form>
