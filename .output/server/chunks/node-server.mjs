...
const _runtimeConfig = (function(a,b){return {app:{baseURL:a,basePath:a,assetsPath:b,cdnURL:"",buildAssetsDir:b},nitro:{routes:{},envPrefix:"NUXT_"},public:{}}}("\u002FHeccusTurbo\u002F","\u002FHeccusTurbo\u002F_nuxt\u002F"));
...
const mergeWithEnvVariables = defu.createDefu((obj, key, _value, namespace) => {
...
const _3def92 = () => import('./renderer.mjs');

const handlers = [
  { route: '', handler: _ab2c5e, lazy: true, method: undefined },
  { route: '/__nuxt_error', handler: _3def92, lazy: true, method: undefined },
  { route: '/**', handler: _3def92, lazy: true, method: undefined }
];
...
export { defu as d, nodeServer as n, useRuntimeConfig as u };
